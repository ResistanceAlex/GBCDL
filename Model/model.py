...
# 定义ResNet模型
class ResNetChange(nn.Module):
    def __init__(self, num_classes, dropout):
        super(ResNetChange, self).__init__()
        self.in_channels = 64
        ...
        self.cooratt = CoordAtt(64, 64).to(device)
...
if __name__ == '__main__':
    ...
    model=ResNetChange(3, 0.5).to(device)
